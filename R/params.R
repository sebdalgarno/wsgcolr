...
#'
#' @param detection_event A tibble of detection path data returned from `detection_event()`containing columns 'transmitter_id', 'timestep', 'path', 'array', 'array_rkm'.
#' @param detection_timestep A tibble of aggregated detection data returned from `detection_timestep()` containing columns 'transmitter_id' and 'timestep'. If `NULL`, argument is ignored.
#' @param detection_complete A tibble of complete detection data returned from `detection_complete()` containing columns 'transmitter_id' and 'timestep'.
#' @param detection_ratio A tibble of detection rtio data returned from `detection_ratio()` containing columns 'timestep', 'n' and 'prop'.
